...
export const comparisons: Comparison[] = [
    ...
    },
    {
        ...
        myApproachTitle: 'Flat-Rate Projects',
        myApproachBody: 'You know the exact cost before work begins. No hourly billing, no scope creep surprises.',
        order: 2,
    },
    {
        id: '3',
        ...
        myApproachBody: 'What used to take months takes days. Your window to market shrinks dramatically.',
        order: 3,
    },
    {
        id: '4',
        ...
        myApproachTitle: 'No Handoff Tax',
        myApproachBody: "There's no designer throwing mockups over a wall to a developer. One person holds the full vision from sketch to production.",
        order: 4,
    },
    {
        id: '5',
